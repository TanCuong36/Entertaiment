			...
			<ul class="list-group">
				...
				<li class="list-group-item"><svg viewBox="0 0 24 24"
						...
						<path
							...
							class="style-scope yt-icon"></path></g></svg> <a href="#"
					class="click_aside" style="text-decoration: none;">Video Đã Xem</a></li>
				<li class="list-group-item"><svg viewBox="0 0 24 24"
						preserveAspectRatio="xMidYMid meet" focusable="false"
						class="style-scope yt-icon"
						style="pointer-events: none; width: 25; height: 25;">
								...
								<div class="row items"
									...
									<div class="col-5">
										<span class="badge badge-dark" style="position: absolute;">PD04237</span><a
											href="/ASM_JAVA4_PD04237/Watch?ID=${item.video.id}"><img class="card-img-top" src="${item.video.poster}"
			...
			<nav aria-label="Page navigation example" style="margin: 0 auto">
				<ul class="pagination">
					...
					<li class="page-item"><a class="page-link"
						href="/ASM_JAVA4_PD04237/Index/Page?page=1">1</a></li>
					<li class="page-item"><a class="page-link"
						href="/ASM_JAVA4_PD04237/Index/Page?page=2">2</a></li>
					<li class="page-item"><a class="page-link"
						href="/ASM_JAVA4_PD04237/Index/Page?page=3">3</a></li>
					<li class="page-item"><a class="page-link" href="#"
